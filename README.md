...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines and quality standard](https://github.com/ciconia/awesome-music/blob/master/CONTRIBUTING.md) ⭐ 2,499 | 🐛 44 | 📅 2026-05-27 first.

Thanks to all [contributors](https://github.com/ciconia/awesome-music/graphs/contributors) ⭐ 2,499 | 🐛 44 | 📅 2026-05-27, you're awesome and this project wouldn't be possible without you!
...
* [Audacity](https://github.com/audacity/audacity) ⭐ 18,560 | 🐛 1,806 | 🌐 C++ | 📅 2026-09-25 - a free, cross-platform digital audio editor.
* [OpenUtau](https://github.com/stakira/openutau/) ⭐ 4,327 | 🐛 130 | 🌐 C# | 📅 2026-09-25 - A free, cross-platform singing voice synthesis framework.
...
* [Librosa](https://github.com/librosa/librosa) ⭐ 8,630 | 🐛 51 | 🌐 Python | 📅 2026-09-24 - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
* [midi.js](https://github.com/mudcube/MIDI.js) ⚠️ Archived - a framework for creating web-based MIDI apps.
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,367 | 🐛 16 | 🌐 C | 📅 2026-03-06 - A library for audio and music analysis, feature extraction.
...
* [Koel](https://github.com/phanan/koel) ⭐ 17,263 | 🐛 20 | 🌐 PHP | 📅 2026-09-25 - an open-source personal audio streaming server.
* [matchering](https://github.com/sergree/matchering) ⭐ 2,646 | 🐛 34 | 🌐 Python | 📅 2026-07-08 - сontainerized web application and library for automated reference audio mastering.
* [fre:ac](https://github.com/enzo1982/freac) ⭐ 1,972 | 🐛 223 | 🌐 C++ | 📅 2026-08-22 - free audio converter. It supports audio CD ripping and tag editing.
* [Whipper](https://github.com/JoeLametta/whipper) ⭐ 1,416 | 🐛 192 | 🌐 Python | 📅 2026-02-17 - Python CD-DA ripper preferring accuracy over speed.
...
* [Jack](https://github.com/jack-cli-cd-ripper/jack) ⭐ 18 | 🐛 8 | 🌐 Python | 📅 2026-09-24 - command-line CD ripper.
...
* [cellist/Lilypond-Sheet-Music](https://github.com/cellist/Lilypond-Sheet-Music) ⭐ 162 | 🐛 1 | 🌐 LilyPond | 📅 2026-09-20 - a collection of music typeset with lilypond (mostly chamber music and music for cello).
...
* [JJazzLab](https://github.com/jjazzboss/JJazzLab) ⭐ 592 | 🐛 27 | 🌐 Java | 📅 2026-09-11 - a complete Midi-based framework for automatic backing tracks generation.
...
* [mididings](https://github.com/mididings/mididings) ⭐ 46 | 🐛 4 | 🌐 Python | 📅 2026-06-23 - A Python-based MIDI router and processor for Linux and macOS
...
* [MuseScore](https://github.com/musescore/MuseScore) ⭐ 15,136 | 🐛 4,272 | 🌐 C++ | 📅 2026-09-25 - free open-source music notation and composition software.
...
* [OpenSheetMusicDisplay](https://github.com/opensheetmusicdisplay/opensheetmusicdisplay) ⭐ 1,971 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-25 - Typescript library for rendering MusicXML in the browser.
* [Frescobaldi](https://github.com/wbsoft/frescobaldi) ⭐ 952 | 🐛 460 | 🌐 Python | 📅 2026-09-06 - a free Lilypond sheet music editor.
* [LibMEI](https://github.com/rism-digital/verovio/tree/develop/libmei) ⭐ 930 | 🐛 175 | 🌐 C++ | 📅 2026-09-25 - a C++ library for reading and writing MEI files.
* [Verovio](https://github.com/rism-ch/verovio) ⭐ 930 | 🐛 175 | 🌐 C++ | 📅 2026-09-25 - a library and a toolkit for engraving MEI music notation into SVG.
...
* [Ripple](https://github.com/ciconia/ripple/) ⭐ 31 | 🐛 1 | 🌐 Ruby | 📅 2023-01-25 - DRY for Lilypond - generate scores and parts with minimal fuss.
...
* [VectorScore](https://github.com/DrakeB1234/VectorScore) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - Lightweight, SVG-based music notation library for TypeScript under MIT license.
...
* [Sardine](https://github.com/Bubobubobubobubo/sardine) ⭐ 325 | 🐛 19 | 🌐 Python | 📅 2025-05-19 - a music live coding library for Python 3.10+ (MIDI/OSC/SuperCollider).
...
* [Midica](https://github.com/truj/midica) ⭐ 135 | 🐛 4 | 🌐 Java | 📅 2025-12-08 - MIDI programming language with decompiler and player, supports karaoke.
...
* [Awesome Music Production](https://github.com/adius/awesome-music-production) ⭐ 1,506 | 🐛 43 | 📅 2026-09-23 - A curated list of software and resources to create music.
...
* [Awesome sheet music](https://github.com/adius/awesome-sheet-music) ⭐ 1,034 | 🐛 8 | 📅 2026-07-01 - A curated list of awesome sheet music software, libraries and resources.
...
* [Awesome Music Programming](https://github.com/zoejane/awesome-music-programming) ⭐ 150 | 🐛 0 | 📅 2026-09-09 - A curated collection of music programming languages, libraries, frameworks and tools.

Other amazingly awesome lists can be found in the [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,256 | 🐛 107 | 📅 2026-09-02 list.
