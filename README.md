...
* [Audacity](https://github.com/audacity/audacity) ⭐ 18,472 | 🐛 1,792 | 🌐 C++ | 📅 2026-09-18 - a free, cross-platform digital audio editor.
* [OpenUtau](https://github.com/stakira/openutau/) ⭐ 4,308 | 🐛 128 | 🌐 C# | 📅 2026-09-18 - A free, cross-platform singing voice synthesis framework.
...
* [howler.js](https://github.com/goldfire/howler.js) ⭐ 25,350 | 🐛 417 | 🌐 JavaScript | 📅 2025-11-23 - a Javascript audio library for the modern web.
* [Librosa](https://github.com/librosa/librosa) ⭐ 8,615 | 🐛 51 | 🌐 Python | 📅 2026-09-16 - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
...
* [Koel](https://github.com/phanan/koel) ⭐ 17,255 | 🐛 15 | 🌐 PHP | 📅 2026-09-17 - an open-source personal audio streaming server.
...
* [Whipper](https://github.com/JoeLametta/whipper) ⭐ 1,413 | 🐛 186 | 🌐 Python | 📅 2026-02-17 - Python CD-DA ripper preferring accuracy over speed.
...
* [mido](https://github.com/mido/mido) ⭐ 1,639 | 🐛 119 | 🌐 Python | 📅 2026-09-16 - Python library for working with MIDI messages and ports.
...
* [MuseScore](https://github.com/musescore/MuseScore) ⭐ 15,119 | 🐛 4,223 | 🌐 C++ | 📅 2026-09-18 - free open-source music notation and composition software.
* [Vexflow](https://github.com/0xfe/vexflow) ⭐ 4,382 | 🐛 52 | 🌐 TypeScript | 📅 2025-03-05 - a JavaScript library for rendering music notation and guitar tablature.
* [OpenSheetMusicDisplay](https://github.com/opensheetmusicdisplay/opensheetmusicdisplay) ⭐ 1,964 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-11 - Typescript library for rendering MusicXML in the browser.
* [Frescobaldi](https://github.com/wbsoft/frescobaldi) ⭐ 951 | 🐛 457 | 🌐 Python | 📅 2026-09-06 - a free Lilypond sheet music editor.
* [LibMEI](https://github.com/rism-digital/verovio/tree/develop/libmei) ⭐ 928 | 🐛 175 | 🌐 C++ | 📅 2026-09-18 - a C++ library for reading and writing MEI files.
* [Verovio](https://github.com/rism-ch/verovio) ⭐ 928 | 🐛 175 | 🌐 C++ | 📅 2026-09-18 - a library and a toolkit for engraving MEI music notation into SVG.
...
* [Orca](https://github.com/hundredrabbits/Orca) ⭐ 5,092 | 🐛 39 | 🌐 JavaScript | 📅 2025-11-16 - live programming environment for music.
...
* [Awesome Music Production](https://github.com/adius/awesome-music-production) ⭐ 1,497 | 🐛 37 | 📅 2026-09-16 - A curated list of software and resources to create music.
* [Awesome Audio DSP](https://github.com/BillyDM/awesome-audio-dsp) ⭐ 1,433 | 🐛 0 | 📅 2026-08-20 - A curated list of audio DSP and plugin development resources.
...
* [Awesome AI Music Generation](https://github.com/Curated-Awesome-Lists/awesome-ai-music-generation) ⭐ 497 | 🐛 8 | 📅 2026-09-04 - A curated list of AI music generation tools and resources.
...
* [Awesome Music Programming](https://github.com/zoejane/awesome-music-programming) ⭐ 148 | 🐛 0 | 📅 2026-09-09 - A curated collection of music programming languages, libraries, frameworks and tools.

Other amazingly awesome lists can be found in the [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,357 | 🐛 106 | 📅 2026-09-02 list.
